...
# --- Global Installer for test-writer Claude Skill ---
...
sed -i.bak "s|/Users/trentrobbins/code/claude-skills-flatagents/test_writer/run.sh|$SCRIPT_DIR/run.sh|g" "$SCRIPT_DIR/SKILL.md"
...
echo ""
echo "Usage: /test-writer src/mymodule.py"
